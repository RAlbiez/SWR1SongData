...
# keep this thing running all the time
while 1:

    # determine time for next run: 5 minutes past next hour
    nextRun = datetime.today() + timedelta(hours=1)
    nextRun = nextRun.replace(minute=5)
